            ...
            <div class="col-lg-8">
                    <div class="card">
                            <div class="card-header">
                                <strong>Update User<span class="float-right"><a href="/users" class="btn btn-outline-secondary btn-sm">Go Back</a><span></strong>
                            </div>
                                ...
                                <form action="{{action('UsersController@update', [$user->id])}}" method="post" class="form-horizontal">
                                        ...
                                        {{ method_field('PUT') }}
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input value="{{$user->email}}"  type="email" id="email" name="email" placeholder="Enter Email" class="form-control">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <select name="role" id="role" class="form-control">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    @foreach ($arr as $item)
                                                                    <option value="{{ $item }}" @if($user->role=== $item) selected='selected' @endif> {{ ucwords($item) }}</option>
                                                                    @endforeach
